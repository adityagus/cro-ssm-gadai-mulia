...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Report Call Not Done</h1>
        </div><!-- /.col -->
        <div class="col-md-12">
          <hr>
		  <button type="button" class="btn btn-default" id="btn_back_detcallnotdone_v1" name="btn_back_detcallnotdone_v1" style="background-color:darkgrey;">Back</button>
      <form action="<?php echo base_url() ?>C_cro/getcustmonthcbg" method="POST" hidden>
        <div class="row">
          <div class="col-md-3">
            <label>Area</label>
			...
			<input type="hidden" name="idsurv_get" id="idsurv_get" value="<?= @$idsurv_get ?>" readonly>
      ...
      <div class="row">
        <div class="col-md-10">
          <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <table id="report_call_not_done" class="">
                <thead>
                <tr>
                  <th>No</th>
                  <th>Tipe</th>
