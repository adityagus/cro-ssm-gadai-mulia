...
<div class="tableFixHead">
          <table class="responsive-table" style="width: 100%; height: 100%; display: block; overflow-x: scroll; white-space: nowrap;" id="tbl_report_survey_bulanan" name="tbl_report_survey_bulanan">
            <thead>
                <tr>
...
<?php
        foreach($DataCompanyAreaCabang as $row_company){
            ...
            if($KodeKantor != @$GetKodeKantor){
                ...
                // if($DataReportBulanan == array() || $DataReportBulanan == NULL || $DataReportBulanan == ''){//Version old null
								if($DataReportBulanan == array() || is_null($DataReportBulanan) || $DataReportBulanan == ''){
        ...
        // print_r($ArrayGetTotal);
        if(@$cek_emptydata == 0){
          echo "<center><p style='color:red;'>Tidak Ada Laporan Survey ALL AREA.</p></center>";
        }else{
        ?>
...
// $(function(){
  $('#btn_export_excel').click(function(e){  
    // e.preventDefault();      
        $('#tbl_report_survey_bulanan').table2excel({
            exclude: ".noExl",
      name: "Excel Document Name",
            filename: "report_survey_bulanan.xls",
            fileext: ".xls",
      exclude_img: true,
            exclude_links: true,
            exclude_inputs: true,
